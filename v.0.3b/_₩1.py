...
def main():
    ...
    for i in range(len(command_result)):
        ...
        try:
            command_result[i] == '미' and command_result[i + 1] == '안'
            sorry()
            plag = + 1
            break
        except IndexError:
        ...
        try:
            command_result[i] == '재' and command_result[i + 1] == '미' and command_result[i + 1] == '있'
            injoy()
            plag = + 1
            break
        except IndexError:
        ...
        try:
            command_result[i] == '재' and command_result[i + 1] == '미' and command_result[i + 1] == '없'
            not_injoy()
            plag = + 1
            break
        except IndexError:
        ...
        try:
            command_result[i] == '배' and command_result[i + 1] == '고' and command_result[i + 1] == '파' or \
            command_result[i] == '허' and command_result[i + 1] == '기'
            hungry(location_2,location_3)
            plag = + 1
            break
        except IndexError:
            pass
        ...
        try:
            command_result[i] == '성' and command_result[i + 1] == '별'
        ...
        try:
            command_result[i] == '나' and command_result[i + 1] == '이'
        ...
        try:
            command_result[i] == '국' and command_result[i + 1] == '적'
        ...
        try:
            command_result[i] == '행' and command_result[i + 1] == '복' or \
            command_result[i] == '좋'
